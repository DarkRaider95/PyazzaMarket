...
# Car color mapping for easy lookup
CAR_COLORS_MAP = {
    'RED': CAR_RED,
    'BLACK': CAR_BLACK,
    'BLUE': CAR_BLUE,
...
# Reverse mapping from path to color name
CAR_PATH_TO_COLOR = {
    CAR_RED: 'RED',
    CAR_BLACK: 'BLACK',
    CAR_BLUE: 'BLUE',
...
ALERT_HEIGHT = 200
ALERT_WIDTH = 600
ALERT_MESSAGE_HEIGHT = 120
ALERT_MESSAGE_WIDTH = 550
ALERT_BUT_HEIGHT = 40
ALERT_BUT_WIDTH = 120
...
# Separate button dimensions for dice overlay (not shared with alerts)
DICE_OVERLAY_BUT_HEIGHT = 30
DICE_OVERLAY_BUT_WIDTH = 100
# Dice overlay message dimensions (smaller than alert messages)
DICE_OVERLAY_MESSAGE_WIDTH = 230
DICE_OVERLAY_MESSAGE_HEIGHT = 30
