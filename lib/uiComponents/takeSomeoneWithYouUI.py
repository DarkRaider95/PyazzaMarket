...
class TakeSomeoneWithYouUI:
    ...
    def draw(self):
        # Create a panel
        self.take_someone_ui = UIPanel(
            relative_rect=pygame.Rect(
                WIDTH // 2 - TAKE_SOMEONE_UI_WIDTH // 2,
                20,
                TAKE_SOMEONE_UI_WIDTH,
                TAKE_SOMEONE_UI_HEIGHT,
            ),
            starting_height=2,
        ...
        title_rect = pygame.Rect(
            (TAKE_SOMEONE_UI_WIDTH // 2 - TAKE_SOMEONE_UI_TITLE_WIDTH // 2, 10),
            (TAKE_SOMEONE_UI_TITLE_WIDTH, TAKE_SOMEONE_UI_TITLE_HEIGHT),
        )
        ...
        self.player_selector = UIDropDownMenu(
            ...
            relative_rect=pygame.Rect(
                TAKE_SOMEONE_UI_WIDTH // 2 - TAKE_SOMEONE_DROPDOWN_WIDTH // 2,
                TAKE_SOMEONE_UI_HEIGHT // 2 - TAKE_SOMEONE_DROPDOWN_HEIGHT // 2,
                TAKE_SOMEONE_DROPDOWN_WIDTH,
                TAKE_SOMEONE_DROPDOWN_HEIGHT,
            ),
            manager=self.manager,
            container=self.take_someone_ui,
        )
        ...
        take_rect = pygame.Rect(
            TAKE_SOMEONE_UI_WIDTH // 2 - TAKE_SOMEONE_UI_BUT_WIDTH // 2,
            TAKE_SOMEONE_UI_HEIGHT - TAKE_SOMEONE_UI_BUT_HEIGHT - 50,
            TAKE_SOMEONE_UI_BUT_WIDTH,
            TAKE_SOMEONE_UI_BUT_HEIGHT,
        )

        self.take_someone_butt = UIButton(
            relative_rect=take_rect,
            text="Scegli",
            container=self.take_someone_ui,
    ...
    def manage_events(self, event):
        ...
        if (
            hasattr(self, "take_someone_butt")
