...
class GameStatus:
    ...
    def set_throw_dices_special(self, value: bool) -> None:
        """Set the value of the throw_dices_special boolean"""
    ...
    def get_throw_dices_turn(self) -> bool:
        """Return the value of the throw_dices_turn boolean"""
        return self.__throw_dices_turn

    def get_throw_dices_special(self) -> bool:
        """Return the value of the throw_dices_special boolean"""
        return self.__throw_dices_special
