...
def test_disable_actions():
    ...
    assert actions_status.get_actions_status() == [False, False, False, False, False, False]
    assert len(actions_status.get_saved_actions()) == 6
...
def test_illegal_renable_actions():
    ...
    assert actions_status.get_actions_status() == [False, False, False, False, True, True]
...
def test_renable_actions():
    ...
    actions_status.disable_actions()
    actions_status.renable_actions()
    assert actions_status.get_actions_status() == [False, True, False, True, True, True]
    assert len(actions_status.get_saved_actions()) == 0
